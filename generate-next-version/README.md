# <img src="../assets/images/github-actions-logo.png" alt="github actions logo" style="height: 32px"  /> actions/generate-next-version
...
- name: Generate next version
  uses: actions/generate-next-version@main
  with:
