# <img src="../assets/images/github-actions-logo.png" alt="github actions logo" style="height: 32px"  /> actions/create-tag-and-pre-release
...
- name: Create Tag and Pre-release
  uses: actions/create-tag-and-pre-release@main
  with:
    version: '1.0.0'
